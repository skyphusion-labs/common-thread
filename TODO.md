...
- [x] Apify Instagram + Reddit ingest (`POST /ingest/apify` auto-detect; dedicated `/apify-instagram` and `/apify-reddit`). TikTok / YouTube / Bluesky / Facebook / Mastodon stay `400 unsupported_export`.
