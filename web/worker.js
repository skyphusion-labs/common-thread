  ...
  <div class="flex">
    ...
    <main class="flex-1 p-6 min-w-0">
      ...
      <section id="tab-upload" class="hidden">
        ...
        <p class="text-sm text-slate-600 mb-6">Upload Apify JSON exports for Twitter/X, Instagram, Reddit, Bluesky, Mastodon, TikTok, or YouTube (YouTube uses titles, descriptions, and comments). Mixed files are split by platform. The backend archives raw data and runs extractors.</p>
