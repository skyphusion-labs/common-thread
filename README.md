...
```
paper/                  Methodology paper, twelve sections plus references
...
examples/               Worked examples (placeholder until anonymized case studies land)
```

## Quick start

Common Thread is bring-your-own-keys for both the scraping layer and the LLM reasoning layer. The reference implementation is pinned to Cloudflare (Workers, D1, R2, AI Gateway with Claude Opus and Haiku models) but the deterministic feature-extraction layer is portable.

1. Clone the repository
2. Configure Cloudflare resources (Workers, D1 database, R2 bucket, AI Gateway)
3. Provide your scraper credentials (Apify or equivalent) and LLM provider credentials
...
**Status:** v1 in active stabilization. Methodology paper complete. Reference implementation in development.

**Citation:** [TBD once Zenodo DOI is established]

**Repository:** github.com/SkyPhusion/common-thread
